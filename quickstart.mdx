...
The agent node is an AI tool that performs a task. It needs three things and an optional fourth thing:
...
- **Optional Tool:** A resource that gives the agent extra abilities, such as sending an email or creating a Google document. Based on the task, the agent will decide whether to use the tool or not.
